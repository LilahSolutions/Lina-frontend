...
const ChevronIcon: FC<ChevronIconProps> = ({
  color = 'currentColor', // Utiliza currentColor para color por defecto
  type,
  size,
  className = '',
  onClick,
  ...
  const sizeClass = {
    small: 'w-2.5 h-2.5', // Tailwind class for small size
    medium: 'w-4 h-4', // Tailwind class for medium size
    large: 'w-5 h-5', // Tailwind class for large size
  };
