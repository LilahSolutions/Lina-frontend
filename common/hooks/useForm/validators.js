 ...
 * is empty before validating it. If the value is empty, the validator must return an empty string.
  /// TODO: @Endolft add an example here.
...
export const _isRequired = (value) => {
...
export const maxDinamicValue = (field, customError) => (value, form) => {
  if (!value) return '';
...
export const minDinamicValue = (field, customMessage) => (value, form) => {
