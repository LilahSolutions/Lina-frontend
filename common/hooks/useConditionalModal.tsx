...
interface ModalComponentProps extends ModalProp {
  show: boolean;
  handleContinue: () => any;
  handleCancel: () => any;
}
...
const useConditionalModal = (
      ...
      return (
        show && (
          <>
            ...
            />
            {show && <style>{`body { overflow: hidden; }`}</style>}
          </>
        )
      );
    },
  ...
  return { StatefulComponent, showComponent, hideComponent, show };
};
